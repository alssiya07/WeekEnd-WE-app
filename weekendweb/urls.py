...
from weekendweb.views import RegisterView,LoginView,IndexView,add_cmd,sign_out_view,commeds_like_view,post_like_view

urlpatterns = [
    path('register/',RegisterView.as_view(),name="signup"),
    path('login/',LoginView.as_view(),name="login"),
    path('index/',IndexView.as_view(),name="home"),
    path("posts/<int:id>/like/add",post_like_view,name="add-likes"),
